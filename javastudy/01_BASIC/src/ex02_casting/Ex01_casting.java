...
public class Ex01_casting {
	...
	public static void main(String[] args) {
		...
		int a = 100;
		System.out.println((double)a); // double로 잠시 형변환 (casting)
		System.out.println((char)a);   // char로 잠시 형변환 (casting)
		
		double b = 99.9;
		System.out.println((int)b);    // 실수가 정수로 casting될 때는 소수 이하 자릿수가 모두 잘림
