...
public class ResponseTextServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try { // NumberFormatException 처리를 위해 예외처리
			...
			// 응답
			response.setContentType("text/plain; charset=UTF-8");  // 텍스트 데이터 타입, 응답 데이터 타입이 text. 
			...
			// 응답 ( catch 블럭에서 응답을 만들어주면 자동으로 error로 이동한다)
