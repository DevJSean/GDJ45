...
public class ModifyService implements EmpService {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		map.put("salary", Long.parseLong(request.getParameter("salary"))); // parseLong 안해도 됨
		map.put("no", Long.parseLong(request.getParameter("no"))); // Oracle이 문자열모양의 숫자 '1'도 자동 인식하기 때문
