...
public class Covid19InfStateService implements OpenAPIService {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			sb.append("&startCreateDt=").append(URLEncoder.encode("20220501", "UTF-8"));
			sb.append("&endCreateDt=").append(URLEncoder.encode("20220504", "UTF-8"));
