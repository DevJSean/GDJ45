		...
		$('#btn').on('click', function(){
			$.ajax({
				...
				success: function(responseText){
					$('#focInfo').empty(); // 목록 초기화
					
					//               xml은 find로 태그를 꺼내올 수 있다.
					$.each($(responseText).find('item'), function(i,item){    // $.each(배열, function(인덱스,요소){})
						var tr = '<tr>';
...
<body>
	...
	<input type="button" value="구로구 포인트 날씨 갱신" id="btn">
