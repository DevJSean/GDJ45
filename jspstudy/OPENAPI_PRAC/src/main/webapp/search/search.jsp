	...
	function fnSearch(){
		$('#btnSearch').on('click', function(){
			$.ajax({
				...
				data: $('#formSearch').serialize(), // serialize는 form이 무조건 있어야 한다.
				type: 'get',
				dataType: 'json',
				success: function(responseText){    // {    items:[{ }, { }, ...  ]  } 
					$('#products').empty(); // 제품 초기화하기
					$.each(responseText.items, function(i, product){  // $.each(배열, function(인덱스, 요소){})
						var tr = '<tr>';
