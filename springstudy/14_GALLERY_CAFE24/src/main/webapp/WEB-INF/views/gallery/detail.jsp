...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#btnChangePage').on('click', function(){
			location.href='${contextPath}/gallery/edit?galleryNo=${gallery.galleryNo}';
		})
...
<body>
	...
	IP ${gallery.ip}<br>
	조회수 ${gallery.hit}<br>
	작성일 ${gallery.createDate}<br>
	수정일 ${gallery.modifyDate}<br><br>
	...
	<c:forEach var="fileAttach" items="${fileAttaches}">
		<div>
			<img alt="${fileAttach.origin}" src="${contextPath}/gallery/display?fileAttachNo=${fileAttach.fileAttachNo}" width="300px">
		</div>
	</c:forEach>
