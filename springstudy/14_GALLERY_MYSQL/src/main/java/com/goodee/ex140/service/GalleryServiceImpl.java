package com.goodee.ex140.service;
...
import com.goodee.ex140.domain.FileAttachDTO;
import com.goodee.ex140.domain.GalleryDTO;
import com.goodee.ex140.mapper.GalleryMapper;
import com.goodee.ex140.util.MyFileUtils;
import com.goodee.ex140.util.PageUtils;
...
//		}
		...
		HttpSession session = request.getSession(); // session 저장소 꺼내기
	...
	public ResponseEntity<Resource> download(String userAgent, Long fileAttachNo) {
		...
		headers.add("Content-Length", file.length()+""); // 길이 정하기
