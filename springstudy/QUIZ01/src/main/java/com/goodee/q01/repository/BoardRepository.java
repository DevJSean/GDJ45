...
public class BoardRepository {
	...
	private DataSource dataSource;   // DBCP 방식
	...
	public int insertBoard(BoardDTO board) {
		...
		try {
			con = dataSource.getConnection();
			sql = "INSERT INTO BOARD VALUES(BOARD_SEQ.NEXTVAL, ?, ?, ?, ?, 0, SYSDATE, SYSDATE)"; // DB에서 Timestamp타입이면 SYSTIMESTAMP
			ps = con.prepareStatement(sql);                                                       // 자바도 Timestamp 타입으로 하면 됨.
